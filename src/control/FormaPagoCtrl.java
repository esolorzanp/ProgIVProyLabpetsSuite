...
public class FormaPagoCtrl implements ActionListener {
    private FormaPago model;
    private FormaPagoDao dao;
    private FormaPagoFrm vista;

    public FormaPagoCtrl(FormaPago model, FormaPagoDao dao, FormaPagoFrm vista) {
        this.model = model;
        this.dao = dao;
        this.vista = vista;
    ...
    private void adicionar() {
        this.model.setFpDescripcion(this.vista.txtDescripcion.getText());
        this.model.setFpEstado("Activo");
    ...
    private void buscar() {
        this.model.setFpId(Integer.parseInt(this.vista.txtBuscar.getText()));
        if (dao.buscarId(this.model)) {
            this.limpiar();
            this.vista.txtDescripcion.setText(this.model.getFpDescripcion());
        }
    }
    ...
    private void listar() {
        ...
        model.setRowCount(0);
        for (FormaPago fp : dao.getTodos(1)) {
